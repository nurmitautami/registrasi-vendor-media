                            ...
                            <div class="p-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="font-size-16 mb-1">Data Utama</h5>
                        ...
                        <div id="personal-data" class="collapse show">
                            <div class="p-4 border-top">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input type="text" class="form-control" id="personal-data-nisn"
                                                name="nisn" placeholder="Masukkan Alamat Email" value="{{ old('nisn') }}" required>
                                            @error('nisn')
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            <label class="form-label" for="personal-data-nik">Nama Perusahaan</label>
                                            <input type="text" class="form-control" id="personal-data-nik" name="nik"
                                                placeholder="Masukkan Nama Perusahaan" value="{{ old('nik') }}" required>
                                            @error('nik')
                                                <div class="alert alert-warning" role="alert">
                                                    <strong>Peringatan!</strong>
                                                    {{ $message }}
